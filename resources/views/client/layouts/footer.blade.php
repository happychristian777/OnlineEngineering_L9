...
<script type="text/javascript">
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-md-6 col-8">
                            ...
                            <div class="logo">
                                <a href="index.html">
                                    <img src="{{url('client')}}/logo.png" class="img-fluid" alt="">
                                </a>
                            </div>
                        </div>
    ...
    <!-- jQuery JS -->
    <script src="{{url('client')}}/js/vendor/jquery-3.5.1.min.js"></script>
    <script src="{{url('client')}}/js/vendor/jquery-migrate-3.3.0.min.js"></script>

    <!-- Bootstrap JS -->
    <script src="{{url('client')}}/js/vendor/bootstrap.min.js"></script>

    <!-- Plugins JS (Please remove the comment from below plugins.min.js for better website load performance and remove plugin js files from avobe) -->

    <script src="{{url('client')}}/js/plugins/plugins.min.js"></script>
