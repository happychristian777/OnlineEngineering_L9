...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{url('client')}}/images/favicon.webp">
    ...
    <link rel="stylesheet" href="{{url('client')}}/css/vendor/vendor.min.css">
    <link rel="stylesheet" href="{{url('client')}}/css/plugins/plugins.min.css">
                                    ...
                                    <div class="header__navigation d-none d-xl-block">
                                        <nav class="navigation-menu navigation-menu--text_white">
                                            ...
                                            <ul>
                                                ...
                                                <li class="">
                                                    <a href="{{ route('team') }}"><span>Team</span></a>
                                                </li>
                                                <li class="">
                                                    <a href="#"><span>Services</span></a>
                                                </li>
                                                <li class="">
                                                    <a href="{{ route('forum_landing') }}"><span>Forums</span></a>
                                                </li>
                                                <li class="">
