                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <div class="software-innovation-hero-wrap wow move-up">
                            <div class="software-innovation-hero-text">
                                ...
                                <h6 class="info-heading">The full set of services around development and maintenance <br> of complex business-critical applications.</h6>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="software-innovation-hero-image animation_images three mt-30">
                            <img src="{{url('client')}}/images/hero/soft-01.webp" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <a href="#" class="projects-wrap style-04 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <div class="image">
                                                    <img class="img-fluid" src="{{url('client')}}/images/icons/soft-s1-01-120x120.webp" alt="">
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <a href="#" class="projects-wrap style-04 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <div class="image">
                                                    <img class="img-fluid" src="{{url('client')}}/images/icons/soft-s1-02-120x120.webp" alt="">
                                                </div>
                                            </div>
                                            <div class="content text-center">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <a href="#" class="projects-wrap style-04 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <div class="image">
                                                    <img class="img-fluid" src="{{url('client')}}/images/icons/soft-s1-03-120x120.webp" alt="">
                                                </div>
                                            </div>
                                            <div class="content text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="image-inner-video-section">
                            <img class="img-fluid border-radus-5" src="{{url('client')}}/images/banners/soft-s2-01.webp" alt="">
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                    ...
                                    <div class="ht-box-images style-10">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{url('client')}}/images/icons/soft-s3-01.webp" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                    ...
                                    <div class="ht-box-images style-10">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{url('client')}}/images/icons/soft-s3-02.webp" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                    ...
                                    <div class="ht-box-images style-10">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{url('client')}}/images/icons/soft-s3-03.webp" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                    ...
                                    <div class="ht-box-images style-10">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{url('client')}}/images/icons/soft-s3-04.webp" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                    ...
                                    <div class="ht-box-images style-10">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{url('client')}}/images/icons/soft-s3-05.webp" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                    ...
                                    <div class="ht-box-images style-10">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{url('client')}}/images/icons/soft-s3-06.webp" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                    ...
                                    <div class="ht-box-images style-10">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{url('client')}}/images/icons/soft-s3-07.webp" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                    ...
                                    <div class="ht-box-images style-10">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="{{url('client')}}/images/icons/soft-s3-08.webp" alt="">
                                            </div>
                                            <div class="content">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <a href="#" class="projects-wrap style-01 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <img class="img-fluid" src="{{url('client')}}/images/projects/case-study-02-480x298.webp" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <a href="#" class="projects-wrap style-01 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <img class="img-fluid" src="{{url('client')}}/images/projects/case-study-03-480x298.webp" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <a href="#" class="projects-wrap style-01 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <img class="img-fluid" src="{{url('client')}}/images/projects/case-study-04-480x298.webp" alt="">
                                            </div>
                                            <div class="content">
                ...
                <div class="row">
                        ...
                        <div class="single-blog-item blog-grid">
                            ...
                            <div class="post-feature blog-thumbnail">
                                <a href="blog-post-layout-one.html">
                                    <img class="img-fluid" src="{{url('client')}}/images/blog/blog-01-370x230.webp" alt="Blog Images">
                                </a>
                            </div>
                            <!-- Post Feature End -->
                    ...
                    <div class="col-lg-4 col-md-6 wow move-up animated">
                        ...
                        <div class="single-blog-item blog-grid">
                            ...
                            <div class="post-feature blog-thumbnail">
                                <a href="blog-post-layout-one.html">
                                    <img class="img-fluid" src="{{url('client')}}/images/blog/blog-02-370x230.webp" alt="Blog Images">
                                </a>
                            </div>
                            <!-- Post Feature End -->
                    ...
                    <div class="col-lg-4 col-md-6 wow move-up animated">
                        ...
                        <div class="single-blog-item blog-grid">
                            ...
                            <div class="post-feature blog-thumbnail">
                                <a href="blog-post-layout-one.html">
                                    <img class="img-fluid" src="{{url('client')}}/images/blog/blog-03-370x230.webp" alt="Blog Images">
                                </a>
                            </div>
                            <!-- Post Feature End -->
